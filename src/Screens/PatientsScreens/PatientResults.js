          ...
          <View style={styles.lowerSection}>
            <View style={{backgroundColor: colors.white, borderTopRightRadius: 60}}>
              <View style={styles.heading}>
                <Image source={images.resultsBlue} style={{width: 30, height: 30}} />
                <Text style={styles.header}>Diagnosis Results</Text>
              </View>
              <View style={styles.container}>
                <Text style={[styles.imageHeader, {marginTop:20}]}>Eyebrow Details </Text>
                {patient && 
